...
def create_program_dir(project_dir, github_url):
    repo_url = github_url + "CameraVideoExtract.git"
    zip_url = github_url + "CameraVideoExtract/archive/refs/heads/gui.zip"
...
def download_and_extract_zip(zip_url, project_dir):
    ...
    zip_path = "CameraVideoExtract-gui.zip"
...
def main():
    ...
    project_dir = "~/CameraVideoExtract-v1.1"
